...
- Smoke test E2E ampliado para 23 verificacoes de regressao.
- Documentacao de setup/operacao em `README.md` e exemplo de ambiente em `.env.example`.

### Changed
- Frontend passou a consumir API por helper centralizado (`public/js/api.js`) com tratamento de erro uniforme.
...
- UX de autenticacao aprimorada no frontend:
  ...
  - retry unico apos `401` quando aplicavel.
